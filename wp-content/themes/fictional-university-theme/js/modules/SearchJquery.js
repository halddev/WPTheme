...
//         // "shorthand" for setTimeout(function() {this.searchField.focus();}, 301);
...
//     //Open and close search overlay when pressing S or esc:
...
//     //Search after x milliseconds, and show spinner:
//     typingLogic() {
...
//     getResults() {
//         //Output result of json using custom search-route, search-route.php
//         //es6 arrow function - "(results) =>" short for "function(results)" as anon func.
